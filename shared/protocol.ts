...
/** Largest legal DCF2 container: header + maximal UTF-8 name/type + file. */
export const MAX_CONTAINER_BYTES = 49 + 2 * 0xffff + MAX_FILE_BYTES;
/**
...
export function parseFrame(
  ...
  if (
    ...
    header.blockLen === 0 ||
    header.totalLen === 0 ||
    header.totalLen > MAX_CONTAINER_BYTES
  ) {
    return null;
  }
